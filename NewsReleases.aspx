<%@ Page Title="" Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="NewsReleases.aspx.cs" Inherits="NewsReleases" %>
        ...
        <ContentTemplate>
            ...
            <asp:UpdatePanel ID="PageUpdatePanel" runat="server">
                <ContentTemplate>
                    ...
                    <asp:SqlDataSource ID="srcYears" runat="server" ConnectionString="<%$ ConnectionStrings:Intranet %>" SelectCommand="Select Distinct Year(ReleaseDate) as YearDate From NewsReleases Where WebFlag = 'Y' ORDER BY Year(ReleaseDate) DESC" />
