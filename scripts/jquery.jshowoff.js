    ...
    $.fn.jshowoff = function (settings) {
        ...
        this.each(function (i) {
            ...
            function addControls() {
                $wrap.append('<p class="jshowoff-controls ' + uniqueClass + '-controls"><a class="jshowoff-play ' + uniqueClass + '-play" href="#null"><font color="#FFFFFF">' + config.controlText.pause + '</font></a> <a class="jshowoff-prev ' + uniqueClass + '-prev" href="#null"><font color="#FFFFFF">' + config.controlText.previous + '</font></a> <a class="jshowoff-next ' + uniqueClass + '-next" href="#null"><font color="#FFFFFF">' + config.controlText.next + '</font></a></p>');
