...
public class ADMethodsAccountManagement
{
    ...
    private string sDomain = "cai.local";
    private string sDefaultOU = "DC=cai,DC=local";
    private string sDefaultRootOU = "DC=cai,DC=local";
    private string sServiceUser = @"cai\website_ad";
    private string sServicePassword = "pwYrnrZ0";
